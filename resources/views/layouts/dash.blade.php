...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('user.dash') }}">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="{{ route('user.dash') }}">
            ...
            {{-- Archive Note --}}
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{ route('archive.note') }}">
            ...
            @php
                ...
                $value_array = [];
                $results = Note::where('user_id', Auth::user()->id)
                    ->with('tags')
                    ->get();
                
                foreach ($results as $result) {
                    if ($result->tags != null && $result->tags != 'null') {
                        foreach ($result->tags as $tag) {
                            if (!in_array(trim($tag->title), $value_array)) {
                                $value_array[] = trim($tag->title);
                            }
                        }
                    }
                }
                $tags = array_unique($value_array);
            @endphp
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        @foreach ($tags as $tag)
                            ...
                            <a class="collapse-item"
                                href={{ route('notes.tag', ['tag' => $tag]) }}>{{ $tag }}</a>
                        @endforeach
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; TodoList 2023</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
